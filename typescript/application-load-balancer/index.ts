...
class LoadBalancerStack extends cdk.Stack {
  constructor(app: cdk.App, id: string) {
    ...
    userData.addCommands(
      ...
      '  <title>Application Load Balancer — CDK Example</title>',
      '  <style>',
      ...
      '      <div class="item"><div class="label">CDK Construct</div><div class="value">elbv2.ApplicationLoadBalancer</div></div>',
      '    </div>',
